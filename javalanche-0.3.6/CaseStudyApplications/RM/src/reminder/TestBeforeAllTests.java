/*---------------------------------------------------------------------
 *  File: $Id: TestBeforeAllTests.java,v 1.2 2005/07/09 23:09:11 gkapfham Exp $   
...
public class TestBeforeAllTests extends DatabaseTestCase
{
	...
	assertTrue(ReminderCreator.databaseServerIsRunning());
