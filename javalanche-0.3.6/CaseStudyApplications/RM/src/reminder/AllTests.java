...
public class AllTests
{
    ...
    public static TestSuite suite()
    {
      /*
       ...
       suite.addTestSuite(reminder.TestBeforeAllTests.class);
		suite.addTestSuite(reminder.TestReminderCreator.class);
		suite.addTestSuite(reminder.TestReminder.class);
		return suite;
	...
	*/
    	...
    	suiteList.add(new TestSuite(TestBeforeAllTests.class));
    	suiteList.add(new TestSuite(TestReminderCreator.class));
    	suiteList.add(new TestSuite(TestReminder.class));
...
// 	    );
	...
	if( doShutdown )
		...
		ReminderCreator.shutdownThroughStatement();
