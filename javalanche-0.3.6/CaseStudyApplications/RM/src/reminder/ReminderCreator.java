/*---------------------------------------------------------------------
 *  File: $Id: ReminderCreator.java,v 1.2 2005/07/08 14:33:14 gkapfham Exp gkapfham $   
...
/**
 *  This class creates the table(s) that are need to store the reminders.
 *
...
public class ReminderCreator
{
	...
	"jdbc:hsqldb:hsql://localhost/ReminderDBMain";
	...
	ReminderCreator.
	    createDatabaseServer("localhost",
				 "ReminderDBMain",
				 "/home/gkapfham/working/research/diatoms/resources/examples/Reminder/db/ReminderDBMain");
   ...
   /**
     ...
     *  @author Gregory M. Kapfhammer 2/19/2005
     */
    public static void createReminderTable(DatabaseDescription describe)
	throws SQLException
    {
	...
	Statement stat = preamble(describe);
        ...
        stat.execute("CREATE TABLE Reminder" + 
		     "(" +
     ...
     *  @author Gregory M. Kapfhammer 2/19/2005
     */
    public static boolean containsReminderTable(DatabaseDescription 
					      describe)
    {
    ...
    /**
     *  Drops the Reminder table.
     *  
     *  @author Gregory M. Kapfhammer 2/19/2005
     */
    public static void dropReminderTable(DatabaseDescription describe)
	throws SQLException
    {

	dropTable(describe, "Reminder");
	...
	System.out.println("CREATE TABLE Reminder" + 
		     "(" +
		     "Id INTEGER IDENTITY not null, " +
		     "Event_Name VarChar(255), " +
		     "Month int, " +
