# FirstSwapGenSANN - swaps a random position from the ordering with the
#  first position
...
NF_LS<- function(Ordering)
{
	...
	# Generate a neighbor by swapping this position with the first case
...
# InOrdSwap consumes an ordering and two Posns (indices), returns neighbor
#  swaps these indices within the ordering, and returns the result
#  For use with SANN neighbor generators
